...
[![GitHub followers](https://img.shields.io/github/followers/alokkumardalei-wq?style=social)](https://github.com/alokkumardalei-wq)
[![GitHub stars](https://img.shields.io/github/stars/alokkumardalei-wq?style=social)](https://github.com/alokkumardalei-wq)
...
const alok = {
    ...
    education: "Vedam School Of Technology",
    currentlyLearning: ["Python", "Golang", "Software Architecture"],
    interests: ["Web Development", "Backend Systems", "Problem Solving"],
    goals: ["Build impactful projects", "Contribute to open source", "Master DSA"],
    funFact: "I debug code faster in the dark 🦇"
};
```
